...
// Font Stacks
font-shorthand($weight = normal, $size = 14px, $lineHeight = 20px)
  font-size: $size
  font-weight: $weight
...
gradientBar($primaryColor, $secondaryColor)
  ...
  border-color: $secondaryColor $secondaryColor darken-fixed($secondaryColor, 15%)
...
// Opacity
opacity($opacity = 100)
  filter: s("alpha(opacity=%d)", $opacity)
